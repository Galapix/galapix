...
#ifndef HEADER_GALAPIX_GALAPIX_TILE_ENTRY_GET_MIN_MAX_SCALE_STATEMENT_HPP
#define HEADER_GALAPIX_GALAPIX_TILE_ENTRY_GET_MIN_MAX_SCALE_STATEMENT_HPP
...
public:
  TileEntryGetMinMaxScaleStatement(SQLiteConnection& db) :
    m_stmt(db, "SELECT MIN(scale) FROM tiles WHERE fileid = ?1;")
  {}
